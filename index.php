...
<html class="no-js" lang="zxx">
            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-2 category-item">
                            <div class="category-circle">
                                <i class="bi bi-phone category-icon"></i>
                            </div>
                            <div class="category-title">Mobile Phones</div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-2 category-item">
                            <div class="category-circle">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 category-item">
                            ...
                            <div class="category-title">Televisions</div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-2 category-item">
                            <div class="category-circle">
    ...
    const toggleButton = document.querySelector('.cat-toggle-btn-2');
    const menu = document.querySelector('.cat__menu');
